...
export default function LoginPage({ onLogin }: Props) {
  ...
  return (
    <div style={{
      ...
      background:'#080a05', fontFamily:'Inter,system-ui,sans-serif', position:'relative', overflowX:'hidden', overflowY:'auto',
      padding: '24px 16px'
    }}>
      {/* Tactical grid */}
      <div className="tactical-grid" style={{ position:'absolute', inset:0, opacity:0.6, pointerEvents:'none' }}/>

      {/* Glow orb */}
      <div style={{ position:'absolute', top:'30%', left:'50%', transform:'translate(-50%,-50%)', width:600, height:600, background:'radial-gradient(ellipse,rgba(74,90,42,0.12) 0%,transparent 70%)', pointerEvents:'none' }}/>
      ...
      <div style={{
        ...
        {/* Left decorative panel (Hidden on small mobile screens or displayed compactly) */}
        <div style={{ flex:'1 1 300px', display:'flex', flexDirection:'column', alignItems:'center', textAlign:'center', gap:16, minWidth:260, maxWidth:360 }}>
          <div className="animate-spin-slow" style={{ display:'inline-block' }}>
            <ChakraLarge/>
          </div>
          <div>
            <h1 style={{ fontSize:26, fontWeight:800, color:'#e8e0d0', letterSpacing:'0.06em', margin:0, lineHeight:1.2 }}>DOCIscan</h1>
            <p style={{ fontSize:11, color:'#FF9933', letterSpacing:'0.18em', marginTop:6, fontWeight:600 }}>DOCUMENT VERIFICATION SYSTEM</p>
            <p style={{ fontSize:11, color:'#4a5a2a', marginTop:10, lineHeight:1.5, maxWidth:280, margin:'10px auto 0' }}>
              Advanced AI-powered document authentication and fake document screening platform.
            </p>
          </div>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:8, width:'100%', maxWidth:280 }}>
            {[
              ...
              <div key={feat} style={{ display:'flex', alignItems:'center', gap:10, padding:'6px 12px', background:'rgba(74,90,42,0.08)', borderRadius:6, border:'1px solid rgba(74,90,42,0.18)', textAlign:'left' }}>
        ...
        <div style={{
          ...
          <div style={{ textAlign:'center', marginBottom:22 }}>
            ...
            <h2 style={{ fontSize:19, fontWeight:700, color:'#e8e0d0', margin:0, letterSpacing:'0.02em' }}>Administrator Login</h2>
            <p style={{ fontSize:11, color:'#5a6a40', marginTop:4, margin:'4px 0 0' }}>Authorised personnel only</p>
          </div>
          ...
          <form onSubmit={handleLogin} style={{ display:'flex', flexDirection:'column', gap:14 }}>
            ...
            <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', padding:'6px 10px', background:'rgba(255,153,51,0.06)', borderRadius:6, border:'1px dashed rgba(255,153,51,0.25)', flexWrap:'wrap', gap:4 }}>
              <span style={{ fontSize:11, color:'#c8a060' }}>Admin Demo:</span>
              <button
                type="button"
          ...
          {/* Security indicators */}
          <div style={{ marginTop:16, padding:'8px 10px', background:'rgba(42,60,18,0.3)', borderRadius:6, border:'1px solid rgba(58,138,72,0.2)' }}>
